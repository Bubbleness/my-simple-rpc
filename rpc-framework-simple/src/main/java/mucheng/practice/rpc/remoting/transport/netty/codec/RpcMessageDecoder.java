package mucheng.practice.rpc.remoting.transport.netty.codec;

import io.netty.buffer.ByteBuf;
import io.netty.channel.ChannelHandlerContext;
import io.netty.handler.codec.LengthFieldBasedFrameDecoder;
import lombok.extern.slf4j.Slf4j;
import mucheng.practice.rpc.compress.Compress;
 ...
 *
 * @author mucheng
 * @date 2023/07/12 14:38:56
 * @description <a href="https://zhuanlan.zhihu.com/p/95621344">LengthFieldBasedFrameDecoder解码器</a>
 */
@Slf4j
public class RpcMessageDecoder extends LengthFieldBasedFrameDecoder {
    ...
    private Object decodeFrame(ByteBuf in) {
        ...
        MyRpcMessage rpcMessage = MyRpcMessage.builder()
                .codec(codecType)
                .requestId(requestId)
        ...
        if (bodyLength > 0) {
            ...
            if (messageType == RpcConstants.REQUEST_TYPE) {
                MyRpcRequest tmpValue = serializer.deserialize(bs, MyRpcRequest.class);
                rpcMessage.setData(tmpValue);
            } else {
                MyRpcResponse tmpValue = serializer.deserialize(bs, MyRpcResponse.class);
                rpcMessage.setData(tmpValue);
            }
        }
        return rpcMessage;
